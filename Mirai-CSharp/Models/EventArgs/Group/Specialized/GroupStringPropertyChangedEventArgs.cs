...
namespace Mirai_CSharp.Models
{
    ...
    public class GroupStringPropertyChangedEventArgs : GroupPropertyChangedEventArgs<string>, IGroupNameChangedEventArgs, IGroupEntranceAnnouncementChangedEventArgs
    {
