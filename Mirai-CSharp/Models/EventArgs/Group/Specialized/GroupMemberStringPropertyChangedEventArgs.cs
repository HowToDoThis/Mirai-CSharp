...
namespace Mirai_CSharp.Models
{
    ...
    public class GroupMemberStringPropertyChangedEventArgs : GroupMemberPropertyChangedEventArgs<string>, IGroupMemberCardChangedEventArgs, IGroupMemberSpecialTitleChangedEventArgs
    {
