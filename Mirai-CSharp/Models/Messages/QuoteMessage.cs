...
namespace Mirai_CSharp.Models
{
    ...
    public class QuoteMessage : Messages
    {
        ...
        public QuoteMessage(int id, long groupId, long senderId, long targetId, IMessageBase[] originChain) : base(MsgType)
        {
            Id = id;
            GroupId = groupId;
            SenderId = senderId;
        ...
        /// <inheritdoc/>
        public override string ToString() => $"[mirai:quote:{Id}]";
    }
}
