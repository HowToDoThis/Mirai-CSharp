...
namespace Mirai_CSharp.Models
{
    ...
    public class FaceMessage : Messages
    {
        ...
        /// </summary>
        /// <remarks>
        /// 编号详见 <a href="https://github.com/mamoe/mirai/blob/2.3-release/mirai-core-api/src/commonMain/kotlin/message/data/Face.kt#L51"/>
        /// </remarks>
        ...
        public FaceMessage(int id, string? name) : base(MsgType)
        {
            Id = id;
            Name = name;
        }
        ...
        /// <inheritdoc/>
        public override string ToString() => $"[mirai:face:{Id}]";
    }
}
