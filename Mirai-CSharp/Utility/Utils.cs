...
namespace Mirai_CSharp.Utility
{
    ...
    {
        public static DateTime UnixTimeStamp2DateTime(int unixTimeStamp) => UnixTimeStamp2DateTime(unixTimeStamp * 1000L);

        public static DateTime UnixTimeStamp2DateTime(long unixTimeStamp) => new DateTime((unixTimeStamp * 10000) + 621355968000000000).ToLocalTime();

        public static int DateTime2UnixTimeStamp(DateTime time) => (int)(DateTime2UnixTimeStamp_Ms(time) / 1000);

        public static long DateTime2UnixTimeStamp_Ms(DateTime time) => (time.ToUniversalTime().Ticks - 621355968000000000) / 10000;
